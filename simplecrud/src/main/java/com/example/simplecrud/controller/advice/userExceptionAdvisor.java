...
@Slf4j
@ControllerAdvice("com.example.simplecrud.controller.UserController")
public class userExceptionAdvisor { //컨트롤러 파일을 패키지로 나눔, controlleradvice를 패키지 별로 적용하기 위함.
    ...
    public ResponseEntity<ErrorResponse> DuplicateError(IllegalArgumentException exception){
